...
export const EXPERTISE_LEVELS: ExpertiseLevelMeta[] = [
  {
    ...
    description: "Every expert was once a beginner. Newcomers have published their first session on OpenClass and are beginning their teaching journey.",
  },
  {
    ...
    description: "Rising Stars have conducted at least 3 sessions and received their first learner feedback. They're actively building their presence on the platform.",
  },
  {
    ...
    description: "Established teachers have hosted 8+ sessions, collected meaningful learner reviews, and maintain a solid rating. Learners can trust them for quality content.",
  },
  {
    level: 4, label: "Expert", icon: "🏆",
    color: "#1d6b3c", bg: "#c6e6d2",
    minSessions: 15, minReviews: 8, minRating: 4.0,
    tagline: "Highly trusted educator",
    description: "Experts are among the top teachers on OpenClass. With 15+ sessions, 8+ glowing reviews, and a 4.0+ rating, they consistently deliver outstanding learning experiences.",
  },
  {
    level: 5, label: "Master", icon: "💎",
    color: "#5b21b6", bg: "#ede9fe",
    minSessions: 25, minReviews: 15, minRating: 4.5,
    tagline: "Elite-tier educator",
    description: "Masters represent the very best on OpenClass. They've conducted 25+ sessions, earned 15+ reviews averaging 4.5 stars or higher, and are consistently engaged with the community.",
  },
];
