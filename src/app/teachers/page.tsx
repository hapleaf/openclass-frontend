...
function TeacherCard({ teacher, isSubscribed, isSubscribing, liveSubCount, onSubscribe }: CardProps) {
  ...
  return (
    ...
    >
      ...
      {/* Body */}
      <div style={{ padding: "1.5rem 1.1rem 0.9rem", flex: 1, display: "flex", flexDirection: "column", gap: "0.4rem", fontFamily: "'DM Sans', sans-serif" }}>
        {/* Name row */}
        <div style={{ display: "flex", alignItems: "flex-start", justifyContent: "space-between", gap: "0.5rem", marginTop: "0.25rem" }}>
          <div style={{ fontFamily: "'Fraunces', Georgia, serif", fontSize: "1rem", fontWeight: 700, color: "#0f1410", lineHeight: 1.2 }}>
            {name}
          </div>
          {(() => {
      ...
      >
        <button
          ...
          style={{ flex: 1, display: "flex", alignItems: "center", justifyContent: "center", padding: "0.55rem", borderRadius: 8, fontSize: "0.82rem", fontWeight: 600, cursor: "pointer", border: "none", background: "#1d6b3c", color: "#fff", fontFamily: "'DM Sans', sans-serif", transition: "background 0.2s" }}
        ...
        <button
          ...
          style={{
            ...
            cursor: isSubscribing ? "default" : "pointer", whiteSpace: "nowrap", fontFamily: "'DM Sans', sans-serif",
...
function FilterOpt({ label, count, active, onClick }: { label: string; count: number; active: boolean; onClick: () => void }) {
  return (
    ...
    >
      ...
      <span style={{ fontSize: "0.84rem", color: active ? "#1d6b3c" : "#3a4140", flex: 1, fontWeight: active ? 500 : 400, fontFamily: "'DM Sans', sans-serif" }}>{label}</span>
        ...
        <div style={{ maxWidth: 1280, margin: "0 auto", padding: isMobile ? "1rem" : "1.75rem 1.5rem", display: "grid", gridTemplateColumns: isMobile ? "1fr" : "260px 1fr", gap: "1.75rem", alignItems: "start" }}>
          ...
          <aside style={{ background: "#fff", border: "1px solid #e2ded6", borderRadius: 14, padding: "1.25rem", position: isMobile ? "static" : "sticky", top: 80, display: isMobile && !filtersOpen ? "none" : undefined }}>
            <div style={{ fontSize: "0.7rem", fontWeight: 700, letterSpacing: "0.08em", textTransform: "uppercase", color: "#6b7a72", marginBottom: "1rem", display: "flex", alignItems: "center", justifyContent: "space-between" }}>
              ...
              {hasFilters && (
                <button
                  ...
                  style={{ fontSize: "0.72rem", fontWeight: 500, color: "#1d6b3c", cursor: "pointer", background: "none", border: "none", padding: 0, fontFamily: "'DM Sans', sans-serif" }}
                >
                  Clear all
                </button>
              )}
            ...
            <div style={{ marginBottom: "1.4rem" }}>
              <div style={{ fontSize: "0.78rem", fontWeight: 600, color: "#0f1410", marginBottom: "0.55rem", fontFamily: "'DM Sans', sans-serif" }}>📚 Area of Expertise</div>
            ...
            {/* Country */}
            <div>
              <div style={{ fontSize: "0.78rem", fontWeight: 600, color: "#0f1410", marginBottom: "0.55rem", fontFamily: "'DM Sans', sans-serif" }}>🌍 Country</div>
              <div style={{ display: "flex", flexDirection: "column", gap: "0.3rem" }}>
          ...
          <main style={{ minWidth: 0 }}>
            ...
            {/* Grid / States */}
            {loading ? (
              <div style={{ textAlign: "center", padding: "4rem", color: "#6b7a72", fontFamily: "'DM Sans', sans-serif" }}>
                Loading teachers…
              </div>
            ) : filtered.length === 0 ? (
